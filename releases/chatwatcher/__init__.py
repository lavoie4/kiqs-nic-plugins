...
class Plugin(BasePlugin):
    ...
    def public_room_message_notification(self, room, user, line):
        ...
        # Played: catch /me actions, rendered as "* <user> <text>"
        if self.settings.get("listenings_enabled", True):
            prefix = f"* {user} "
    ...
    def _build_shitlist_settings(self):
        ...
        self._feeds["shitlist"]["stats_sort_combo"] = sort_combo
        ...
        self._feeds["shitlist"]["stats_widget"] = stats_list
        self._feeds["shitlist"]["stats_scroll"] = stats_scroll
