...
CHAT_APPLY_TOOLTIP = (
    "Mirrors Nicotine+'s own setting. To fully apply it, open Nicotine+'s "
    "main Preferences and press OK, or restart Nicotine+."
)
    ...
    def _build_chat_page(self, Gtk, Gdk):
        ...
        hint = Gtk.Label(
            label="These mirror Nicotine+'s chat/interface appearance settings. "
                  "Changes may need Nicotine+'s main Preferences opened and OK pressed "
                  "(or a restart) to fully apply. Leave a field empty to use the theme default.",
            xalign=0, wrap=True
        )
        hint.add_css_class("dim-label")
        page.append(hint)
